...
// @todos dispatch these helpers into appropriated helpers/helpers.* file and write unit tests!
require(27)(Chart);
...
var exports = module.exports = {
	 ...
	 * @todos handle `radius` as top-left, top-right, bottom-right, bottom-left array/object?
	 */
...
module.exports = function(Chart) {
	...
	var LogarithmicScale = Chart.Scale.extend({
		...
		getPixelForValue: function(value) {
			...
			if (me.isHorizontal()) {
				range = helpers.log10(me.end) - helpers.log10(start); // todos: if start === 0
				if (newVal === 0) {
					pixel = me.left;
				} else {
